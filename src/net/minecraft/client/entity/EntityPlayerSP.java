...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.onGround && !flag1 && Client.modmanager.getModuleByClass(ToggleSprint.class).isEnable() && this.movementInput.moveForward >= f && !this.isSprinting() && !this.isUsingItem() && flag2 && !this.isPotionActive(Potion.blindness))
        {
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= f&&flag2 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness) && Client.modmanager.getModuleByClass(ToggleSprint.class).isEnable() || this.mc.gameSettings.keyBindSprint.isKeyDown())
        {
            this.setSprinting(true);
        }
